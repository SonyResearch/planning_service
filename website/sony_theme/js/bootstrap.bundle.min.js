  ...
  'object' == typeof exports&& 'undefined' != typeof module ?
      ...
      show() {
        ...
        if (this._config.parent
                && (t = this._getFirstLevelChildren(
                            ...
                            .map((
                                t => Bt.getOrCreateInstance(t, {toggle: !1})))),
    ...
    function We(t) {
      ...
      if (c) {
        ...
        A === fe(i) && 'static' !== xe(A = Le(i)).position && 'absolute' === a
            ...
            || (v = qt,
                f -=
                (d && A === w && w.visualViewport ? w.visualViewport.width :
                                                    A[T])
                    - n.width,
                f *= l ? 1 : -1)
      }
      ...
      return e === Gt ?
          ...
          function(t, e) {
            ...
            return i.top = i.top + t.clientTop, i.left = i.left + t.clientLeft,
                   ...
                   i.right = i.left + t.clientWidth, i.width = t.clientWidth,
          ...
          Ze(function(t) {
            var e, i = Le(t), n = Xe(t),
                   ...
                   o =
                       ve(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0,
                          s ? s.clientWidth : 0),
                   r =
                       ve(i.scrollHeight, i.clientHeight,
      ...
      fn: function(t) {
        ...
        if (!e.modifiersData[n]._skip) {
          for (var s = i.mainAxis, o = void 0 === s || s, r = i.altAxis,
                   a = void 0 === r || r, l = i.fallbackPlacements,
                   c = i.padding, h = i.boundary, d = i.rootBoundary,
                   u = i.altBoundary, f = i.flipVariations,
                   p = void 0 === f || f, m = i.allowedAutoPlacements,
                   g = e.options.placement, _ = be(g),
                   b = l
                   || (_ !== g && p ?
                           function(t) {
                             if (be(t) === Kt) return [];
    ...
    function di(t, e, i) {
      ...
      var n, s, o = me(e), r = me(e) && function(t) {
        ...
        return 1 !== i || 1 !== n
      }(e), a = Le(e), l = Te(t, r, i), c = {scrollLeft: 0, scrollTop: 0}, h = {
        x: 0,
        y: 0
      };
      return (o || !o && !i)
                  ...
                  return t.enabled
                       ...
                       a.orderedModifiers.forEach((function(t) {
                         ...
                         if ('function' == typeof s) {
                           var o =
                               s({state: a, name: e, instance: h, options: n});
                           l.push(o || function() {})
                         }
                       })),
                       h.update()
    ...
    class Ui extends H {
      ...
      dispose() {
        this._isAppended
            && (N.off(this._element, Qi), this._element.remove(),
                this._isAppended = !1)
      }
      _getElement() {
        if (!this._element) {
