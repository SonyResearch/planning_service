...
The robot uses a [service](https://en.wikipedia.org/wiki/Service-oriented_architecture) to solve for motion plans which satisfy constraints. This `PlanningService` consists of an `app` which:
