...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var search_modal =
      new bootstrap.Modal(document.getElementById('mkdocs_search_modal'));
  var keyboard_modal =
      new bootstrap.Modal(document.getElementById('mkdocs_keyboard_modal'));
  ...
  document.getElementById('mkdocs_search_modal')
  ...
  document.getElementById('mkdocs-search-results')
  ...
  document.querySelector('.help.shortcut kbd').innerHTML =
      keyCodes[shortcuts.help];
  document.querySelector('.prev.shortcut kbd').innerHTML =
      keyCodes[shortcuts.previous];
  document.querySelector('.next.shortcut kbd').innerHTML =
      keyCodes[shortcuts.next];
  document.querySelector('.search.shortcut kbd').innerHTML =
  ...
  function showInnerDropdown(item) {
    ...
    container.querySelectorAll(':scope > .dropdown-submenu > a')
        .forEach(function(el) {
          if (el !== item) {
  ...
  document.querySelectorAll('.dropdown-menu').forEach(function(menu) {
    menu.parentElement.addEventListener('hide.bs.dropdown', function() {
      ...
      menu.querySelectorAll('.dropdown-menu .dropdown-menu')
...
var scrollSpy = new bootstrap.ScrollSpy(document.body, {target: '.bs-sidebar'});
...
// See
// https://www.cambiaresearch.com/articles/15/javascript-char-codes-key-codes We
// only list common keys below. Obscure keys are omitted and their use is
// discouraged.
var keyCodes = {
  8: 'backspace',
  9: 'tab',
