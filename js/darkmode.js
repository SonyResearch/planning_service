function setColorMode(mode) {
  // Switch between light/dark theme. `mode` is a string value of either 'dark'
  // or 'light'.
...
function updateModeToggle(mode) {
  ...
  document.querySelectorAll('[data-bs-theme-value]').forEach(function(toggle) {
    if (mode == toggle.getAttribute('data-bs-theme-value')) {
      ...
      menu.firstElementChild.setAttribute(
          'class', toggle.firstElementChild.getAttribute('class'));
    } else {
